...
const Header: React.FC = () => {
  ...
  <a href="/freeBoard" className="hover:text-gray-400">
    freeBoard
  </a>
    ...
    >
      ...
      {menuOpen && (
        <div className="absolute top-16 right-0 bg-white shadow-md rounded-lg p-4 lg:hidden">
          ...
          <a href="/siteRecipe" className="block hover:text-gray-400">
            siteRecipe
          </a>
          <a href="/userRecipe" className="block hover:text-gray-400">
            userRecipe
          </a>
          <a href="/freeBoard" className="block hover:text-gray-400">
            freeBoard
          </a>
          <a href="/myPage" className="block hover:text-gray-400">
            myPage
          </a>
