...
//                         <div className='font-semibold mb-2'>요리정보</div>
//                     </div>
//                 </div>
//             </div>
//             <div className='w-full max-w-6xl p-4 border border-gray-300 mt-4'>
//                 <div className='font-semibold'>재료정보</div>
//             </div>
//             <div className='w-full max-w-6xl p-4 border border-gray-300 mt-4'></div>
//             <div className='w-full max-w-6xl p-4 border border-gray-300 mt-4'></div>
//             <div className='w-full max-w-6xl p-4 border border-gray-300 mt-4'></div>
//             <div className='w-full max-w-6xl p-4 border border-gray-300 mt-4'></div>
//         </main>
                ...
                <div className='flex space-x-4 px-8'>
                    ...
                    <div className='mb-4 flex-grow flex flex-col'>
                        ...
                        <textarea
                            ...
                            rows={4}
                        ></textarea>
                        <div className='font-semibold mb-2'>동영상</div>
                        <input
                            type='text'
                            className='w-full bg-gray-200 p-2 mb-2'
                            placeholder='동영상이 있으면 주소를 입력하세요. (Youtube, 네이버 tvcast, 다음 tvpot 만 가능) 예) http://youtu.be/IA0Bxo3lZmM'
                        />
