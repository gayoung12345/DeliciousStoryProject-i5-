...
const siteRecipe = () => {
  return (
    <main>
      ...
      <div className="container mx-auto columns-1 sm:columns-2 md:columns-3 xl:columns-4" style={{ display: "flex", flexWrap: "wrap"}}>
        {photos.length > 0 ? (
          photos.map((photo) => (
      ...
      <Button size="md" variant="solid" action="primary" style={{color:"#ffffff", backgroundColor:"#000000", position:"absolute", bottom: 50, right:50, width:80, height:80, borderRadius:40}} >
          <ButtonText><Icon as={EditIcon} size="md" /></ButtonText>
        </Button>
